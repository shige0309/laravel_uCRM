                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-600" v-if="$page.props.errors.name">{{ $page.props.errors.name }}</div>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-600" v-if="$page.props.errors.memo">{{ $page.props.errors.memo }}</div>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class="text-red-600" v-if="$page.props.errors.is_selling">{{ $page.props.errors.is_selling }}</div>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
